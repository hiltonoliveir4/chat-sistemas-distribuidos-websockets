class Interpreter {
  ...
  help() {
    this.socket.send(
      "[SISTEMA]<----- Lista de Comandos -----><br>*Criar salas: /createroom<br>Mostrar salas: /rooms<br>Entrar em sala: /joinroom *numero da sala*<br>Sair da aplicação: /sair<br>Trocar nome de usuário: /myname *Seu_Nome* (não use espaços)<br>Se promover para admin: /promotetoadmin *senha de acesso do app*<br>Remover usuário da sala: /kick *numero da sala* *id do usuario*<br>Banir usuário da sala: /ban *numero da sala* *id do usuario*"
    );
  }
